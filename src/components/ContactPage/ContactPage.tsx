...
export class ContactPage extends React.Component<undefined, ContactPageState> {
            ...
            <section className="section section-partnership">
                ...
                <div className="section-half half-second">
                    <div className="contact-info">
                        <OnDesktop>
                            <div><h4 className="section-subtitle">Контакты</h4>
                            ...
                            <div>
                                ...
                                <div className="social-list">
                                    <a href="#" className="social-list__item">
                                        <svg className="icon icon_soc-git" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="1855 809 20 21.655">
                                            <g transform="translate(1835.433 809)">
                                                <path className="icon_fill" fill="#484848"
                                    ...
                                    <a href="#" className="social-list__item">
                                        <svg className="icon icon_soc-be" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="1855 855 20 12.451">
                                    ...
                                    <a href="#" className="social-list__item">
                                        <svg className="icon icon_soc-li" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="1855 893 16 15.776">
                ...
                <OnMobileTablet>
                    <Modal isOpen={this.state.isModalOpen} contentLabel="Modal-partnership">
    ...
    private handleModalState(isModalOpen: boolean) {
        this.setState({isModalOpen});
    }

    protected get submitButton(): JSX.Element {
        return (
            <button className={`btn btn_primary${this.state.isOnSubmit ? " is-hovered" : ""}`} type="submit">
                Отправить
    ...
    protected get modalOpenButton(): JSX.Element {
        return (
            <button
                className={`btn btn_primary${this.state.isModalOpen ? " is-hovered" : ""}`}
                onClick={this.handleModalState.bind(this, true)}
                type="button"
            >
                Сотрудничать
                <span className="btn-corners btn-corners_top"/>
    ...
    protected get modalCloseButton(): JSX.Element {
        return (
            <button
                className={`btn`}
                onClick={this.handleModalState.bind(this, false)}
                type="button"
            >
                CLOSE
            </button>
...
// tslint:disable
    ...
    protected get submitForm(): JSX.Element {
        return (
